...
# GID_CLASSES = ['Invalid', 'build', 'farmland', 'forest', 'meadow', 'water']
...
class Loader(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        bin_label_s = rescale_image(label_mask_s, 8, 2)
        ...
        bin_label_s = rescale_image(label_mask_s, 8, 2)
        return data_s, label_s,label_mask_s,bin_label_s, data, label
